...
function Sidebar() {
    ...
    return (
        <aside className="flex w-full md:h-full md:max-h-full md:min-h-full md:w-auto">
            <div
                className={cn(
                    "fixed bottom-0 left-0 z-50 flex h-[65px] w-full gap-4 self-end overflow-hidden border-t border-darkHover bg-dark p-2 md:static md:h-full md:w-[50px] md:min-w-[50px] md:flex-col md:border-r md:border-t-0 md:p-2 md:pt-4",
                    {
            ...
            <div
                className="absolute left-0 top-0 z-20 w-full flex-col bg-[#0b0b0f] border-r border-white/5 md:static md:min-w-[320px]"
